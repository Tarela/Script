...
write.table(summary_V,file=paste0(tissue,"_mergePeak_flank",flankN,"_ATAC2DNase_Ustart_Vmat.txt"),row.names=T,col.names=T,quote=F,sep="\t")
write.table(summary_U,file=paste0(tissue,"_mergePeak_flank",flankN,"_ATAC2DNase_Ustart_Umat.txt"),row.names=T,col.names=T,quote=F,sep="\t")
