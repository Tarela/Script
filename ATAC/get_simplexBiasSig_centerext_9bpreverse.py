...
#                print chrm,start,end,i,mcuts,minus_biassum,minus_biasCB
        newll = ll + [plus_readscount,minus_readscount,plus_biassum,minus_biassum,plus_biasCB,minus_biasCB] #+ list(plus_data) + list(minus_data)
...
#========major options=============
    ...
    #optparser.add_option("-e","--ext",dest="ext",type="str",default=500,
