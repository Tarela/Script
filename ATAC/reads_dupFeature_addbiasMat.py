...
def PEreads_feature(ll, GCrange, flank, genome2bit,biasMat):
    ...
    return ll + [biasP,biasN,seqGC,fraglen]
...
#========major options=============
    ...
    optparser.add_option("-b","--biasfile",dest="biasfile",type="str",default='/nv/vol190/zanglab/sh8tv/Project/scATAC/Data/nakedDNA/ATAC/Yeast_naked_SRA054922/process36bp/SRR515381_Enc8mer.txt',
