...
def bias_scan_fxr(peak,outname,biasMat,Gen,offset):
...
#========major options=============
    ...
    optparser.add_option("-b","--biasMat",dest="bgmatrix",type="str",default = "/nv/vol190/zanglab/sh8tv/Project/scATAC/Data/Summary_Data/bias_matrix/summary36bp/singleMat/NakedYeast_ATAC_Enc8mer.txt",
...
#========minor options=============
    ...
    #if biastype == "fxr":
    bias_scan_fxr(interval,outname,bgmatrix,gen,offset)
