...
def get_regionLevel_simplex_parameters(inputbed,outputbed,plusbw,minusbw,biasmat,ext,genome2bit):
    ...
    for line in inf:
        ...
        for i in range(len(plusSig)):
            ...
            if pcuts > 0:
                ...
                if not "N" in pseq:
                    p_out = seq2biasParm(seqlist[random.randint(0,65535)],B,simplex_code)
        ...
        for i in range(len(minusSig)):
            ...
            if mcuts > 0:
                ...
                if not "N" in tmpseq:
                    ...
                    m_out = seq2biasParm(seqlist[random.randint(0,65535)],B,simplex_code)
...
#========minor options=============
    ...
    if not inputbed or not outputbed:
        ...
        sys.exit(1)
    get_regionLevel_simplex_parameters(inputbed,outputbed,plusbw,minusbw,biasmat,options.ext,options.sequence)
