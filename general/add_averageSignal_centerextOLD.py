...
def get_signal(inputfile,output,signalbw,bwfolder,ext):
    ...
    for line in inf:
        ...
        for bwHandle in bwHs:
            addsig  = bwsig_Ave(bwHandle,ll[0],max(0,center-ext),center+ext,1)
            ll.append(addsig)
...
#========minor options=============
    ...
    get_signal(inputfile,output,signalbw,bwfolder,options.ext)
