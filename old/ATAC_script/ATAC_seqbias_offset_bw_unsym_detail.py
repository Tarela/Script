...
def build_nmer_model(fp, w_plus,w_minus,out,single_nmer_cut,sequence,lflank,rflank,offset):
    ...
    for seqtype in sorted(dall.keys()):
        ...
        pcut = str(cut_nmer_dict[seqtype])
        ncut = str(cut_nmer_dict[rev(seqtype)])
        bgseq = str(seq_nmer_dict[seqtype])
        outf.write("\t".join([seqtype,pout,nout,pcut,ncut,bgseq])+"\n")
    outf.close()
...
#========major options=============
    ...
    optparser.add_option("--genome",dest="genome",type="str",default = '/mnt/Storage/home/huse/Data/Genome/hg19/hg19.2bit',
                         help="twobit sequence file , default : /mnt/Storage/home/huse/Data/Genome/hg19/hg19.2bit")
