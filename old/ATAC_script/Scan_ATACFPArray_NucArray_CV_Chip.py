...
def getsignal(inputfile,outputfile,BGmatrix,pcut,ncut,conserve,chipbw,atacnucbw,mnasebw,dnase_span,mnase_span,gen,fetch_length=100):
 ...
 #       chrom_len[i['key']] = i['chromSize']
    ...
    for line in inf:
        ...
        atacnucout = make_mnase(atacnuc_bw,ll,mnase_span)
        ...
        if strand != '-':
            ...
            pbglist = n[::-1]
            nbglist = p[::-1]
        newll = ll + atacnucout + mnaseout + pout + nout + pbglist + nbglist + conserveout + chipout
...
#========major options=============
    ...
    optparser.add_option("-a","--atacnucbw",dest="atacnucbw",type="str",
                         help="")
...
#========minor options=============
    ...
    atacnucbw = options.atacnucbw
    if not inputfile:
        optparser.print_help()
        sys.exit(1)
    
    getsignal(inputfile,outputfile,bgmatrix,pcut,ncut,conserve,chipbw,atacnucbw,mnasebw,Dspan,Mspan,genome,fetch_length=100)
