...
def getsignal(inputfile,outputfile,atacBGmatrix,dnaseBGmatrix,atacpcut,atacncut,dnasepcut,dnasencut,conserve,dnase_span,gen,fetch_length=100):
 ...
 #       chrom_len[i['key']] = i['chromSize']
    ...
    for line in inf:
        ...
        newll = ll  + atacpout + atacnout + atacpbglist + atacnbglist + dnasepout + dnasenout + dnasepbglist + dnasenbglist + conserveout 
...
#========minor options=============
    ...
    getsignal(inputfile,outputfile,options.atacBGmatrix,options.dnaseBGmatrix,options.atacpcut,options.atacncut,options.dnasepcut,options.dnasencut,conserve,Dspan,genome,fetch_length=100)    
