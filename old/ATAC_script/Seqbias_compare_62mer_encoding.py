...
#            nx.append(nBG[nseq] * pBG[nseq_apart])
            ...
            p_yf = predict2(pseq,b0f,b1f,b2f,8)
            p_yr = predict2(revcomp(pseq_apart),b0f,b1f,b2f,8)[::-1]
            pnew.append(pow(numpy.e,(p_yf+p_yr)[0]))
            
            n_yr= predict2(nseq_apart,b0f,b1f,b2f,8)
            n_yf = predict2(revcomp(nseq),b0f,b1f,b2f,8)[::-1]
            nnew.append(pow(numpy.e,(n_yf+n_yr)[0]))
            
        ### new method
        
#        code_seq = genome[chrm][(start-offset +bpshift -span):(end+12 - bpshfit +span)].upper()
#        seq_f = code_seq[:-9]
#        seq_r = code_seq[9:]
...
#            nx_assign.append(ntotal * nx[bp+span]/sum(nx[bp:(bp+2*span)]))
    ...
    #        nnewlin_assign.append(ntotal * nnew_linear[bp+span]/sum(nnew_linear[bp:(bp+2*span)]))
        ...
        newll = ll + p_sum[span:(len(p_sum)-span)] + n_sum[span:(len(n_sum)-span)] +   pnew_assign + nnew_assign
...
#========major options=============
    ...
    optparser.add_option("--w2",dest="w_minus",type="str",default = "/mnt/Storage2/home/huse/ATAC/Data/ATAC/Bam/GM12878_ATACseq_50k_m.bw",
                         help="")
    optparser.add_option("--bg1",dest="bgmatrix",type="str",default = "/mnt/Storage2/home/huse/ATAC/Data/ATAC/biasoffset/up3down3/GM12878_ATACseq_50k_bias_onPeak_u3d3s0_newcode.txt",
...
#========minor options=============
    ...
    optparser.add_option("--bpshift",dest="bpshift",type="int",default = 1,
