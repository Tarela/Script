...
#            nx_assign.append(ntotal * nx[bp+span]/sum(nx[bp:(bp+2*span)]))
  #          pnew_prop.append(pnew[bp+span]/sum(pnew[bp:(bp+2*span)]))
  #          nnew_prop.append(nnew[bp+span]/sum(nnew[bp:(bp+2*span)]))
    ...
    #        nnewlin_assign.append(ntotal * nnew_linear[bp+span]/sum(nnew_linear[bp:(bp+2*span)]))
        ...
        newll = ll +  p_sum[span:(len(p_sum)-span)] + n_sum[span:(len(n_sum)-span)] +pnew[span:(len(p_sum)-span)] + nnew[span:(len(n_sum)-span)] + pnew_assign + nnew_assign# + pnew_prop + nnew_prop
...
#========major options=============
    ...
    optparser.add_option("-o","--output",dest="output",type="str",
                         help="")
    optparser.add_option("--w1",dest="w_plus",type="str",default = "/mnt/Storage3/home/huse/ATAC/Data/ATAC/Bam/GM12878_ATACseq_50k_p.bw",
                         help="")
    optparser.add_option("--w2",dest="w_minus",type="str",default = "/mnt/Storage3/home/huse/ATAC/Data/ATAC/Bam/GM12878_ATACseq_50k_m.bw",
                         help="")
    optparser.add_option("-b","--bg",dest="bgmatrix",type="str",default = "/mnt/Storage3/home/huse/ATAC/Data/ATAC/biasoffset/up4down4/GM12878_ATACseq_50k_bias_onPeak_u4d4s0_newcode.txt",
