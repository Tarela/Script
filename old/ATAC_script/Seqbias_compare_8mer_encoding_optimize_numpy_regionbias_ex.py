      ...
      #      print line
       ...
       #     print line 
        ...
        for bp in range(len(p_sum)- 2*tag_span):
            ...
            p_prop_assign.append( ptotal * sum(pnew[(bp+tag_span-bias_span):(bp+tag_span+bias_span)])/sum(pnew[(bp):(bp+2*tag_span)]) / (2*bias_span) )            #ptotal * pnew[bp+tag_span]/sum(pnew[bp:(bp+2*tag_span)]))
            n_prop_assign.append( ntotal * sum(nnew[(bp+tag_span-bias_span):(bp+tag_span+bias_span)])/sum(nnew[(bp):(bp+2*tag_span)]) / (2*bias_span) )            #ptotal * pnew[bp+tag_span]/sum(pnew[bp:(bp+2*tag_span)]))
            ...
            p_equal_assign.append(ptotal/(2*tag_span))
            n_equal_assign.append(ntotal/(2*tag_span))
        ...
        newll = ll + pobs + nobs + pbig_mean_assign + nbig_mean_assign + p_prop_assign + n_prop_assign +p_equal_assign+n_equal_assign # +  p_sum[span:(len(p_sum)-span)] + n_sum[span:(len(n_sum)-span)] +pnew[span:(len(p_sum)-span)] + nnew[span:(len(n_sum)-span)] + pnew_assign + nnew_assign
