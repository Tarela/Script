...
def getsignal(inputfile,outputfile,pcut,ncut,pspan,tspan,fetch_length=100):
...
#    method = options.method
    ...
    getsignal(inputfile,outputfile,pcut,ncut,pspan,tspan,fetch_length=100)
