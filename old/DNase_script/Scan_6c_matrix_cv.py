...
def getsignal(inputfile,outputfile,BGmatrix,pcut,ncut,Ipcut,Incut,conserve,pspan,tspan,gen,fetch_length=100):
 ...
 #       chrom_len[i['key']] = i['chromSize']
    ...
    for line in inf:
        ...
        newll = ll  + [TC,FOS] + pout + nout + Ipout + Inout + pbglist + nbglist + conserveout 
...
#    method = options.method
    ...
    getsignal(inputfile,outputfile,bgmatrix,pcut,ncut,pIcut,nIcut,conserve,pspan,tspan,genome,fetch_length=100)
