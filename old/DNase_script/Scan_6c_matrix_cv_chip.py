...
def getsignal(inputfile,outputfile,BGmatrix,pcut,ncut,Ipcut,Incut,conserve,chipbw,pspan,tspan,gen,fetch_length=100):
 ...
 #       chrom_len[i['key']] = i['chromSize']
    ...
    for line in inf:
        ...
        newll = ll  + [TC,FOS] + pout + nout + Ipout + Inout + pbglist + nbglist + conserveout + chipout
...
#========major options=============
    ...
    optparser.add_option("-n","--negative_cut",dest="ncut",type="str",
                         help="")
    optparser.add_option("-q","--positive_Input_cut",dest="pIcut",type="str",
                         help="")
    optparser.add_option("-l","--negative_Input_cut",dest="nIcut",type="str",
                         help="")
...
#    method = options.method
    ...
    getsignal(inputfile,outputfile,bgmatrix,pcut,ncut,pIcut,nIcut,conserve,chipbw,pspan,tspan,genome,fetch_length=100)
