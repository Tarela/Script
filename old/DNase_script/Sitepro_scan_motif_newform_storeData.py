...
def sitepro_scan(peak,out,w_plus,w_minus):
    ...
    for line in inf:### chr start end name motifscore strand FP DNase chip
        ...
        if chrom_len1.has_key(ll[0])  and chrom_len2.has_key(ll[0]):
            DNase100p = float(w_plus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-50,(int(ll[1])+int(ll[2]))/2+50,1).sum_data)
            DNase100m = float(w_minus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-50,(int(ll[1])+int(ll[2]))/2+50,1).sum_data) 
            DNase200p = float(w_plus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-100,(int(ll[1])+int(ll[2]))/2+100,1).sum_data)
            DNase200m = float(w_minus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-100,(int(ll[1])+int(ll[2]))/2+100,1).sum_data)
            DNase300p = float(w_plus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-150,(int(ll[1])+int(ll[2]))/2+150,1).sum_data)
            DNase300m = float(w_minus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-150,(int(ll[1])+int(ll[2]))/2+150,1).sum_data)
            DNase400p = float(w_plus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-200,(int(ll[1])+int(ll[2]))/2+200,1).sum_data)
            DNase400m = float(w_minus_H.summarize(ll[0],(int(ll[1])+int(ll[2]))/2-200,(int(ll[1])+int(ll[2]))/2+200,1).sum_data)
