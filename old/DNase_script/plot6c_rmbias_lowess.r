...
sitepro(mpl,mnl,c("red","blue"),c("plus lowess","minus lowess"),"lowess rmBias")
#sitepro(mpsub,mnsub,c("red","blue"),c("plusCut/pluslowess","minusCut/minuslowess"),"Cut/lowess")
