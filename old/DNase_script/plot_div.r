...
allcvp <- log2(allc/allp)
allcvc <- log2(allc/allc2)
...
pdf(file=outfile,height=9,width=16*2/3)
par(oma = c(1, 1,1, 1),mar=c(1.0, 1.0, 1.0, 1.0))
layout(matrix(c(1,2,3,10,4,6,8,11,5,7,9,12),nrow=3,byrow=T),heights=c(1,2,0.25))
sitepro1(mallc,"black","","observe cleavage")
sitepro1(mallcvp,"red","","log2(obs/exp)")
sitepro1(mallcvc,"red","","log2(rep1/rep2)")

bi_heatmap(allc,c("black","white"),0.99,"")
bi_heatmap(allcvp,c("blue","white","red"),0.99,"")
bi_heatmap(allcvc,c("blue","white","red"),0.99,"")
plot(1,1,type="n",axes=F,xlab="",ylab="")
bi_heatmap(chip,c("white","blue"),0.99,"Chip")
